...
const Map2 = ({ dataImages }) => {
  ...
  useEffect(() => {
    ...
    if (isLoaded) {
      const lat = dataImages?.items?.location_lat?.text ? Number(dataImages?.items?.location_lat?.text) : 24.14691252116138;
      const lng = dataImages?.items?.location_lng?.text ? Number(dataImages?.items?.location_lng?.text) : 47.3199603;
